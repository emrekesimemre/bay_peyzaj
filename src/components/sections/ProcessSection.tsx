    ...
    <section className="py-24 md:py-36 px-6 md:px-16 bg-stone-50">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="font-serif text-lg md:text-xl text-antrasit/60 italic leading-relaxed max-w-md">{t("subtitle")}</p>
        </motion.div>
            ...
            >
              ...
              <div className="relative z-10 p-8 lg:pr-12 border-b sm:border-b-0 sm:border-r border-antrasit/8 last:border-r-0 last:border-b-0">
                <div className="flex items-start justify-between mb-8">
                  ...
                  <span className="font-sans text-4xl font-semibold text-antrasit/6 select-none leading-none">{step.number}</span>
                </div>
                <h3 className="font-serif text-xl md:text-2xl text-antrasit mb-3 leading-snug">{t(step.titleKey)}</h3>
                <p className="font-sans text-sm text-antrasit/50 leading-relaxed">{t(step.descKey)}</p>
