...
const steps = [
  {
    ...
    title: "Keşif & Analiz",
    description:
      "Arazinizi yerinde inceliyor, iklim koşullarını ve toprağın karakterini analiz ediyoruz. İhtiyaçlarınızı ve hayallerinizi dinliyoruz.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Özgün konsept ve 3D görselleştirmeler ile projenizi hayata geçirmeden önce gözlerinizin önüne sererız. Her detay üzerinde birlikte kararlar alırız.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.2} className="w-7 h-7">
  ...
  },
  {
    ...
    title: "Uygulama",
    description:
      "Onaylanan projeyi, uzman ekibimiz ve seçilmiş malzemelerle öngörülen süre ve bütçe içinde hayata geçiririz. Her aşama kontrol altındadır.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.2} className="w-7 h-7">
  ...
  {
    number: "04",
    title: "Teslimat & Bakım",
    description:
      "Projeniz teslim edilirken detaylı bakım rehberi sunulur. İsteğe bağlı periyodik bakım sözleşmesi ile bahçenizi dört mevsim canlı tutuyoruz.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.2} className="w-7 h-7">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="font-serif text-lg md:text-xl text-antrasit/60 italic leading-relaxed max-w-md">
            İlk görüşmeden son teslimat anına kadar şeffaf ve öngörülebilir bir süreç.
          </p>
        </motion.div>

        {/* Adımlar */}
        <div ref={ref} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-0">
          {steps.map((step, i) => (
            <motion.div
              key={step.number}
            ...
            >
              ...
              {i < steps.length - 1 && (
                <motion.div
                  ...
                  transition={{ duration: 0.6, ease: easeOut, delay: 0.4 + i * 0.13 }}
              ...
              <div className="relative z-10 p-8 lg:pr-12 border-b sm:border-b-0 sm:border-r border-antrasit/8 last:border-r-0 last:border-b-0">
                ...
                {/* Alt vurgu çizgisi — hover'da görünür */}
