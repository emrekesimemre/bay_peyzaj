        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
          <div className="flex flex-col gap-8">
            <div className="mb-4">
              ...
              <motion.h2 className="font-serif text-5xl md:text-6xl lg:text-7xl font-semibold text-antrasit tracking-tight leading-tight" {...fadeUp(0.1)}>
                {t("h2")}
              </motion.h2>
          ...
          <motion.div ref={imageRef} className="relative w-full aspect-4/5 overflow-hidden rounded-sm" {...fadeUp(0.35)}>
