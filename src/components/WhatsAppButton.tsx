...
export default function WhatsAppButton() {
  ...
  const href = `${SITE.social.whatsapp}?text=${message}`;
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-5 h-5 md:w-6 md:h-6" aria-hidden="true" fill="#25D366">
