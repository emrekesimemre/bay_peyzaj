...
const contactItems = [
  {
    label: "Adres",
    value: "Kızılay Mah. Bahçe Sk. No:12\nAnkara, Türkiye",
  },
  {
    label: "E-posta",
    value: "info@baypeyzaj.com",
    href: "mailto:info@baypeyzaj.com",
  },
  {
    label: "Telefon",
    value: "+90 (555) 123 45 67",
    href: "tel:+905067876301",
  },
  {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl font-semibold leading-tight text-saf-beyaz max-w-2xl">
            Projenizi Birlikte
            <br />
            <span className="text-servi-yesili italic">Hayata Geçirelim</span>
          </h2>
        </motion.div>
        ...
        >
          ...
          <p className="font-sans text-xs text-white/30 tracking-wide text-center">
            © {new Date().getFullYear()} Bay Peyzaj. Tüm hakları saklıdır.
          </p>
          {/* Sosyal Medya */}
          <div className="flex items-center gap-5">
            <a
              href="https://instagram.com/baypeyzaj"
              target="_blank"
            ...
            <a
              href="https://linkedin.com/company/baypeyzaj"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
              className="text-white/30 hover:text-servi-yesili transition-colors duration-300"
